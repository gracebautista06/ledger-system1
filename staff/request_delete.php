...
// Ownership check — same pattern as request_edit.php
$original = null;
if ($type === 'Harvest') {
...
// Check for already-pending DELETE request
...
");
        $ins->bind_param("isis", $staff_id, $type, $id, $reason);
        ...
        if ($ins->execute()) {
            ...
            log_session_activity($conn, 'Delete Request Sent', "Requested deletion of $type #$id — reason: $reason");
    ...
    <?php else: ?>
        ...
        <form method="POST">
            <div class="form-group">
                <label>Why do you need this record deleted? <span style="color:var(--danger);">*</span></label>
