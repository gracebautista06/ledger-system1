...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_profile') {
        ...
        $pic_filename = $user['profile_pic']; // keep existing by default
        ...
        if (!empty($_FILES['profile_pic']['name'])) {
            ...
            if (!in_array($ext, $allowed_ext)) {
                ...
                $pic_filename = 'owner_' . $user_id . '_' . time() . '.' . $ext;
                if (!move_uploaded_file($tmp_path, $upload_dir . $pic_filename)) {
...
$total_batches  = (int)$conn->query("SELECT COUNT(*) AS c FROM batches WHERE status='Active'")->fetch_assoc()['c'];
$total_pending  = (int)$conn->query("SELECT COUNT(*) AS c FROM edit_requests WHERE status='Pending'")->fetch_assoc()['c'];
?>
...
.avatar-upload-btn:hover { background: var(--terra-lt); }
...
.profile-hero-info .profile-username {
    font-size: 0.83rem;
    color: var(--text-muted);
    margin-bottom: 10px;
}
.profile-hero-info .profile-bio {
    font-size: 0.87rem;
...
.profile-stat-pill strong { color: var(--gold); }
...
.profile-section-header .section-icon-svg {
    flex-shrink: 0;
}
    ...
    <div class="page-header">
        <div>
            <h2 style="display:flex;align-items:center;gap:10px;">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                My Profile
            </h2>
    ...
    <div class="profile-hero">
        ...
        <div class="avatar-wrap">
            <form method="POST" enctype="multipart/form-data" id="avatar-form">
                ...
                <div class="avatar-ring">
                    <?php if ($avatar_url): ?>
                        <img src="<?php echo $avatar_url; ?>" alt="Profile Picture" id="avatar-preview">
                    <?php else: ?>
                        <div class="avatar-initials" id="avatar-preview-initials">
                            <?php echo strtoupper(substr($display, 0, 1)); ?>
                        </div>
                    <?php endif; ?>
                </div>
                <label class="avatar-upload-btn" title="Change photo" for="pic-input">
        ...
        <div class="profile-hero-info">
            ...
            <div class="profile-username">
                ...
                &nbsp;
                <span class="badge badge-owner" style="font-size:0.6rem; vertical-align:middle;">Owner</span>
            </div>
            ...
            <div class="profile-stats">
                <div class="profile-stat-pill">
                    <strong><?php echo $total_staff; ?></strong> Staff Managed
                </div>
                <div class="profile-stat-pill">
                    <strong><?php echo $total_batches; ?></strong> Active Batches
                </div>
                <div class="profile-stat-pill">
                    <strong><?php echo $total_pending; ?></strong> Pending Requests
                </div>
            </div>
        </div>
    ...
    <div class="profile-grid">
        ...
        <div class="profile-section">
            <div class="profile-section-header">
                <svg class="section-icon-svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                <h3>Edit Profile</h3>
            </div>
            <div class="profile-section-body">
                <form method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="action" value="update_profile">
                    <!-- Hidden file input synced from avatar form -->
                ...
                <div class="danger-zone" style="margin-top:1rem; padding:.8rem 1rem;">
                    <div>
                        <p>Remove profile picture</p>
                        <small>This will revert to your initial avatar.</small>
                    </div>
                    <form method="POST"
        ...
        <div>
            <div class="profile-section">
                <div class="profile-section-header">
                    <svg class="section-icon-svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            ...
            <div class="profile-section" style="margin-top:1.4rem;">
                <div class="profile-section-header">
                    <svg class="section-icon-svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    <h3>Account Info</h3>
                </div>
...
function previewAvatar(input) {
    ...
    reader.onload = function(e) {
        ...
        ring.innerHTML = `<img src="${e.target.result}" alt="Preview" style="width:100%;height:100%;border-radius:50%;object-fit:cover;">`;
    };
